      ...
      <div>
        {
          orders.map((order,index) => (
            <div className="grid grid-cols-1 sm:gid-cols-[1fr_2fr_1fr] lg:grid-cols-[1fr_2fr_1fr_1fr_1fr] gap-3 items-start  border-2 border-gray-200 p-5 md:p-8 my-3 md:my-4 text-xs sm:text-sm text-gray" key={index}>
