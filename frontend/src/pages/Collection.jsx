...
if (subCategory.includes(e.target.value)){
 ...
 const sortProduct = ()=>{
  ...
  switch (sortType){
    case 'low-high': (fpCopy((a,b)=> (a.price - b.price) ));
    break;
    case 'high-low': (fpCopy((a,b)=> (b.price - a.price) ));
    break;
    default:
      applyFilter();
      break;
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t">
      ...
      <div className="min-w-60 ">
        ...
        <p className="mb-3 text-sm font-md">CATEGORIES</p>
      ...
      <div className={`border border-gray-300 pl-5 py-3 my-5 ${showFilters ? '' : 'hidden'} sm:block`}>
        <p className="mb-3 text-sm font-md">TYPE</p>
        <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
          <p className="flex gap-2">
